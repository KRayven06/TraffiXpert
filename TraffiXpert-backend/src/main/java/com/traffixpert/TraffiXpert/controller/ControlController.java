...
public class ControlController {
    ...
    public ResponseEntity<Void> stopAllTraffic() {
        ...
        // simulationService.toggleAutoMode(); // Removed - Stop shouldn't necessarily
        // disable auto mode logic? Decide behavior.
     ...
     * Accessed via POST request to /api/control/stop-simulation (renamed to avoid
     * conflict)
     * 
     * @return ResponseEntity indicating success.
     */
